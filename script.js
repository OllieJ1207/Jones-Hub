...
const navButtons = [
  {page: "", icon: "dashboard", disabled: false},
  {page: "listsPage.html", icon: "list_alt", disabled: false},
  ...
  {page: "settingsPage.html", icon: "settings", disabled: false},
  {page: "function:Refresh", icon: "refresh", disabled: true},
]
